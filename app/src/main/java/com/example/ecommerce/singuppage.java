    ...
    private void Validatephonenum(String name, String phone, String password, String username)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful())
                                    {
                                        ...
                                        loadingbar.dismiss();
                                        Intent intent=new Intent(singuppage.this, page4.class);
                                    ...
                                    {
                                        loadingbar.dismiss();
                                        Toast.makeText(singuppage.this, "Network error occurred: Try again later...", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                ...
                {
                    Toast.makeText(singuppage.this, "An account is already linked to this phone number", Toast.LENGTH_SHORT).show();
                    loadingbar.dismiss();
                    Toast.makeText(singuppage.this, "Try using another phone number", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(singuppage.this, page3.class);
                    startActivity(intent);
                }
            }
