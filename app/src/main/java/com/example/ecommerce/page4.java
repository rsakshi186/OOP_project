...
public class page4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPhone = findViewById(R.id.login_ph_num);
        edtOTP = findViewById(R.id.login_enter_otp);
        verifyOTPBtn = findViewById(R.id.login_verify_and_signin);
        generateOTPBtn = findViewById(R.id.login_generate_otp);
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    ...
                    Toast.makeText(page4.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(edtPhone.getText().toString()) && TextUtils.isEmpty(edtOTP.getText().toString()))
                {
                    Loginuser();
                }
                    ...
                    Toast.makeText(page4.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void access(String password, String username) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    Toast.makeText(page4.this, "Incorrect login credentials", Toast.LENGTH_SHORT).show();
                    loadingbar.dismiss();
                }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(page4.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
